...
7. Do NOT use standalone `rotate()` or `translate()` functions. To place or rotate objects, use Context Managers like `with Locations(...)`, `with PolarLocations(...)`, or `with GridLocations(...)`.
